    ...
    ClientPairingProps.encode = function encode(message, writer) {
      ...
      if (
        ...
        writer
          ...
          .bool(message.isChatDbLidMigrated);
      if (
        ...
        writer
          ...
          .bool(message.isSyncdPureLidSession);
      if (
        ...
        writer
          ...
          .bool(message.isSyncdSnapshotRecoveryEnabled);
      return writer;
    };
    /**
    ...
    EncryptedPairingRequest.encode = function encode(message, writer) {
      ...
      if (
        ...
        writer
          ...
          .bytes(message.encryptedPayload);
  ...
  CompanionReg.PairingRequest = (function () {
    ...
    PairingRequest.encode = function encode(message, writer) {
      ...
      if (
        ...
        writer
          .uint32(/* id 1, wireType 2 =*/ 10)
          .bytes(message.companionPublicKey);
      if (
        ...
        writer
          ...
          .bytes(message.companionIdentityKey);
      if (
  ...
  CompanionReg.ProloguePayload = (function () {
    ...
    ProloguePayload.encode = function encode(message, writer) {
      ...
      if (
        ...
        writer
          .uint32(/* id 1, wireType 2 =*/ 10)
          .bytes(message.companionEphemeralIdentity);
      if (
    ...
    DeviceProps.HistorySyncConfig = (function () {
      ...
      HistorySyncConfig.encode = function encode(message, writer) {
        ...
        if (
          ...
          writer
            .uint32(/* id 1, wireType 0 =*/ 8)
            .uint32(message.fullSyncDaysLimit);
        if (
          ...
          writer
            .uint32(/* id 2, wireType 0 =*/ 16)
            .uint32(message.fullSyncSizeMbLimit);
        if (
        ...
        if (
          ...
          writer
            ...
            .bool(message.inlineInitialPayloadInE2EeMsg);
        if (
          ...
          writer
            ...
            .uint32(message.recentSyncDaysLimit);
        if (
          ...
          writer
            ...
            .bool(message.supportCallLogHistory);
        if (
          ...
          writer
            ...
            .bool(message.supportBotUserAgentChatHistory);
        if (
          ...
          writer
            ...
            .bool(message.supportCagReactionsAndPolls);
        if (
          ...
          writer
            ...
            .bool(message.supportBizHostedMsg);
        if (
        ...
        if (
          ...
          writer
            ...
            .bool(message.supportHostedGroupMsg);
        if (
          ...
          writer
            ...
            .bool(message.supportFbidBotChatHistory);
        if (
          ...
          writer
            ...
            .bool(message.supportAddOnHistorySyncMigration);
        if (
          ...
          writer
            ...
            .bool(message.supportMessageAssociation);
        return writer;
      };
      /**
