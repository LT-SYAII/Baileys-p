...
export namespace SignalLocalStorageProtocol {
  ...
  interface ISenderKeyRecordStructure {
    ...
    senderKeyStates?:
      | SignalLocalStorageProtocol.ISenderKeyStateStructure[]
      | null;
  }
  ...
  interface ISessionStructure {
    ...
    receiverChains?:
      | SignalLocalStorageProtocol.SessionStructure.IChain[]
      | null;
  ...
  namespace SessionStructure {
    ...
    interface IChain {
      ...
      /** Chain messageKeys */
      messageKeys?:
        | SignalLocalStorageProtocol.SessionStructure.Chain.IMessageKey[]
        | null;
    }
    /** Represents a Chain. */
