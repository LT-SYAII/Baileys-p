    ...
    SessionStructure.encode = function encode(message, writer) {
      ...
      if (
        ...
        writer
          ...
          .bytes(message.localIdentityPublic);
      if (
        ...
        writer
          ...
          .bytes(message.remoteIdentityPublic);
      if (
      ...
      if (
        ...
        writer
          ...
          .uint32(message.remoteRegistrationId);
      if (
        ...
        writer
          ...
          .uint32(message.localRegistrationId);
      if (
      ...
      Chain.encode = function encode(message, writer) {
        ...
        if (
          ...
          writer
            ...
            .bytes(message.senderRatchetKey);
        if (
          ...
          writer
            .uint32(/* id 2, wireType 2 =*/ 18)
            .bytes(message.senderRatchetKeyPrivate);
        if (
    ...
    SessionStructure.PendingKeyExchange = (function () {
      ...
      PendingKeyExchange.encode = function encode(message, writer) {
        ...
        if (
          ...
          writer
            .uint32(/* id 3, wireType 2 =*/ 26)
            .bytes(message.localBaseKeyPrivate);
        if (
        ...
        if (
          ...
          writer
            ...
            .bytes(message.localRatchetKeyPrivate);
        if (
          ...
          writer
            ...
            .bytes(message.localIdentityKey);
        if (
          ...
          writer
            ...
            .bytes(message.localIdentityKeyPrivate);
        return writer;
      };
      /**
