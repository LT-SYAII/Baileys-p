      ...
      ExternalShare.encode = function encode(message, writer) {
        ...
        if (
          ...
          writer
            ...
            .string(message.actionFallbackUrl);
        return writer;
      };
      /**
      ...
      Music.encode = function encode(message, writer) {
        ...
        if (
          ...
          writer
            ...
            .string(message.artistAttribution);
        if (
        ...
        Metadata.encode = function encode(message, writer) {
          ...
          if (
            ...
            writer
              ...
              .int32(message.channelMessageId);
          if (
            ...
            writer
              ...
              .bool(message.hasMultipleReshares);
          return writer;
        };
        /**
