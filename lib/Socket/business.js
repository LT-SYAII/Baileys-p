...
const makeBusinessSocket = (config) => {
  ...
  const productUpdate = async (productId, update) => {
    update = await business_1.uploadingNecessaryImagesOfProduct(
      update,
      waUploadToServer,
    );
    ...
    const productNode = generic_utils_1.getBinaryNodeChild(
  ...
  const productCreate = async (create) => {
    ...
    create = await business_1.uploadingNecessaryImagesOfProduct(
      create,
      waUploadToServer,
    );
