    ...
    (async () => {
      try {
        ...
        if (requiresDurationComputation) {
          uploadData.seconds =
            await messages_media_1.getAudioDuration(originalFilePath);
...
const generateWAMessageContent = async (message, options) => {
  ...
  if ("text" in message) {
    ...
    if (message.live) {
      locationMessage = {
        liveLocationMessage:
          Types_1.WAProto.Message.LiveLocationMessage.fromObject(
            message.location,
          ),
      };
    } else {
    ...
    if (options.getProfilePicUrl) {
      ...
      const { thumbnail } = await messages_media_1.generateThumbnail(
        pfpUrl,
        "image",
      );
    ...
    switch (message.type) {
      case "list":
        m.listResponseMessage = {
          ...
          lisType:
            WAProto_1.proto.Message.ListResponseMessage.ListType.SINGLE_SELECT,
        };
        break;
      case "template":
      ...
      case "interactive":
        m.interactiveResponseMessage = {
          body: {
            ...
            format:
              WAProto_1.proto.Message.InteractiveResponseMessage.Body.Format
                .EXTENSIONS_1,
          },
    ...
    m.eventMessage = Types_1.WAProto.Message.EventMessage.fromObject(
      message.event,
    );
  ...
  if ("sections" in message && !!message.sections) {
    ...
    if ("text" in message) {
      ...
      buttonsMessage.headerType =
        WAProto_1.proto.Message.ButtonsMessage.HeaderType.EMPTY;
    } else {
      ...
      buttonsMessage.headerType =
        WAProto_1.proto.Message.ButtonsMessage.HeaderType[type];
    ...
    if ("title" in message && !!message.title) {
      ...
      buttonsMessage.headerType =
        WAProto_1.proto.Message.ButtonsMessage.HeaderType.TEXT;
    }
...
const extractMessageContent = (content) => {
  ...
  if (
    (_g =
      content === null || content === void 0
        ? void 0
        : content.templateMessage) === null || _g === void 0
      ? void 0
      : _g.fourRowTemplate
  ) {
    return extractFromTemplateMessage(
      (_h =
        content === null || content === void 0
          ? void 0
          : content.templateMessage) === null || _h === void 0
        ? void 0
        : _h.fourRowTemplate,
    );
  }
  if (
    (_i =
      content === null || content === void 0
        ? void 0
        : content.interactiveMessage) === null || _i === void 0
      ? void 0
      : _i.shopStorefrontMessage
  ) {
    return extractFromTemplateMessage(
      (_j =
        content === null || content === void 0
          ? void 0
          : content.interactiveMessage) === null || _j === void 0
        ? void 0
        : _j.shopStorefrontMessage,
    );
  }
  if (
    (_k =
      content === null || content === void 0
        ? void 0
        : content.interactiveMessage) === null || _k === void 0
      ? void 0
      : _k.collectionMessage
  ) {
    return extractFromTemplateMessage(
      (_l =
        content === null || content === void 0
          ? void 0
          : content.interactiveMessage) === null || _l === void 0
        ? void 0
        : _l.collectionMessage,
    );
  }
  if (
    (_m =
      content === null || content === void 0
        ? void 0
        : content.interactiveMessage) === null || _m === void 0
      ? void 0
      : _m.nativeFlowMessage
  ) {
    return extractFromTemplateMessage(
      (_n =
        content === null || content === void 0
          ? void 0
          : content.interactiveMessage) === null || _n === void 0
        ? void 0
        : _n.nativeFlowMessage,
    );
  }
  if (
    (_o =
      content === null || content === void 0
        ? void 0
        : content.interactiveMessage) === null || _o === void 0
      ? void 0
      : _o.carouselMessage
  ) {
    return extractFromTemplateMessage(
      (_p =
        content === null || content === void 0
          ? void 0
          : content.interactiveMessage) === null || _p === void 0
        ? void 0
        : _p.carouselMessage,
    );
  }
