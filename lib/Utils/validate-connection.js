...
const configureSuccessfulPairing = (
  ...
  const deviceIdentityNode = WABinary_1.getBinaryNodeChild(
    pairSuccessNode,
    "device-identity",
  );
  const platformNode = WABinary_1.getBinaryNodeChild(
    pairSuccessNode,
    "platform",
  );
  ...
  // check HMAC matches
  const advSign = crypto_2.hmacSign(
    details,
